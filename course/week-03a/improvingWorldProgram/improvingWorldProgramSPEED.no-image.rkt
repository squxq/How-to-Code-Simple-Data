...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname improvingWorldProgram.no-image) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
