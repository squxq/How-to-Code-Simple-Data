...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname even-more-arithmetic-expression-starter.no-image) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
