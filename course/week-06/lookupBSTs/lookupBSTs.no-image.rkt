...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname lookupBSTs.no-image) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
