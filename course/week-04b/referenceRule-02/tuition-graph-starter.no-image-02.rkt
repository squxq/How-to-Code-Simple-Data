...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname tuition-graph-starter.no-image-02) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
